...
const { STYLESHEETS } = PROJECT_CONFIG;
                ...
                if (directoryPresent) {
                    ...
                    FS.mkdir(solvedDirPath, (err, resp) => {
                        ...
                        if (newRootPath === solvedDirPath) {
                            ...
                            FS.appendFile(
                                `${STYLESHEETS}/static/index.scss`,
                                '\n@import \'fe-components/' + DIR_PATH[0] + '/components-entry\';', () => {
                        }
                            );
                        } else {
                            FS.appendFile(
                            ...
                            FS.appendFile(
                                ...
                                '\nimport \'./' + DIR_PATH[adjustedPaths.indexOf(individualPath)] + '/components-entry.js\';', () => {
                        }
                            );
                        }
